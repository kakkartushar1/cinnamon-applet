...
To install the applet just symlink checkout directory into @~/.local/share/cinnamon/desklets/@
...
pre. git clone https://github.com/kakkartushar1/cinnamon-applet.git ~/.local/share/cinnamon/desklets/hamster@projecthamster.wordpress.com
