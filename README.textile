...
ln -s /path/to/the/checkout hamster@kakkatushar1

You can also clone git project exactly to applets folder

pre. git clone https://github.com/kakkartushar1/cinnamon-applet.git ~/.local/share/cinnamon/desklets/hamster@kakkartushar1
